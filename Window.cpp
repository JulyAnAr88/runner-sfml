...
void Window::setup(const std::string& title, const sf::Vector2u& size){
	...
	m_eventManager.addCallback(SceneType(0),"Fullscreen_toggle",&Window::toggleFullscreen,this);
	m_eventManager.addCallback(SceneType(0),"Window_close",&Window::close,this);
